...
class ATPG {
 public:
  ...
  void tdfault_sim_a_vector(const string &, int &, int &, bool &);
  void tdfault_sim_a_vector2(const string &, int &, int &, bool &);
  ...
  void test();
   ...
   /* added */
  void test_tdfatpg();
  bool get_tdfatpg() {return tdfatpg;}
 ...
 private:
  ...
  bool detected_for_sim;
  void SCOAP_ctrlability();
  void SCOAP_obsrability();
  void mark_fanin(const wptr, vector<wptr> &);
  int tdf_podem();
  fptr choose_primary_fault(forward_list<fptr>);
  int tdf_find_v2(fptr ,int &,string& , bool,string&,bool,forward_list<wptr>&);
  int tdf_find_v1(fptr , int &, string&,forward_list<wptr>&);
  fptr choose_secondary_fault(forward_list<fptr>, fptr);
  wptr test_possible_2(const fptr,int&);
  void tdfault_sim_a_vector_without_dropping(const string &, int &,int &, bool &);
  void tdfault_sim_a_vector2_without_dropping(const string &, int &, int &, bool &); 
    ///////////////////////////////////////////////////////////////
  //YEH
  void STC();
  wptr find_pi_assignment_2(const wptr,int&);
  wptr find_hardest_control_scoap(const nptr, const int);
  wptr find_easiest_control_scoap(const nptr, const int);

  bool enough_x(const string&) const;
  ...
  int random_sim_num=0;
  bool stc_use_sorted=false;
  int random_sim_num_post=0;
...
////////////////////////////////////////////////////////////////////////////////////////////
  ...
  class FAULT {
   public:
    ...
    forward_list<wptr> decision_tree_prim;
    string allAssigned_prim;
